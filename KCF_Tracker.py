...
def limit(rect, limit_):
    if rect[0] + rect[2] > limit_[0] + limit_[2]:
        rect[2] = limit_[0] + limit_[2] - rect[0]
    if rect[1] + rect[3] > limit_[1] + limit_[3]:
        rect[3] = limit_[1] + limit_[3] - rect[1]
    if rect[0] < limit_[0]:
        rect[2] -= (limit_[0] - rect[0])
        rect[0] = limit_[0]
    if rect[1] < limit_[1]:
        rect[3] -= (limit_[1] - rect[1])
        rect[1] = limit_[1]
    if rect[2] < 0:
        rect[2] = 0
    if rect[3] < 0:
